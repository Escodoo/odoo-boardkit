...
_From template_ in the Boards catalogue. The board is built on `hr.payslip`
(OCA Payroll) and lands unpublished so it can be reviewed before users see it.
...
![Payroll Overview](../static/description/images/boardkit-payroll-overview.png)
